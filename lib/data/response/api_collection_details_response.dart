class ApiCollectionDetailsResponse {
  bool? success;
  String? message;
  List<Data>? data;

  ApiCollectionDetailsResponse({this.success, this.message, this.data});

  ApiCollectionDetailsResponse.fromJson(Map<String, dynamic> json) {
